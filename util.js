...
function loadSound(path) {
    return p5.prototype.loadSound.call({ _decrementPreload: () => { } }, path);
}
    ...
    return {
        obstacles: data.obstacles.map(o => {
            ...
            return new obstacle(
                ...
                d.tint,
                d.layer,
                { x: Matter.Vertices.centre(body.vertices).x - o.x + d.xOffset, y: Matter.Vertices.centre(body.vertices).y - o.y + d.yOffset, angle: d.angleOffset * Math.PI / 180 },
                d.imageMode,
                d.health,
                d.roof && {
                    ...
                    aboveGround: d.roof.aboveGround ?? false,
                    deck: d.roof.deck ?? false
                }
            );
        }),
