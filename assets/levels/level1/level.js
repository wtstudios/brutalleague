            ...
            const s = p5 => {
                ...
                p5.mousePressed = function () {/*
                    if (p5.mouseButton == p5.LEFT) {
                        sightArray.push({ x: p5.round((levelData.players[playerNum].body.position.x + (p5.mouseX - p5.width / 2) * 2.2) / 10) * 10 - 540, y: p5.round((levelData.players[playerNum].body.position.y + (p5.mouseY - p5.height / 2) * 2.2) / 10) * 10 - 540});
                    }*/
                };
                ...
                p5.draw = function () {
                    ...
                    for (let m = 0; m < sightArray.length; m++) {
                        p5.ellipse(sightArray[m].x + 540, sightArray[m].y + 540, 60, 60);
                        if (m > 0) {
                            p5.line(sightArray[m].x + 540, sightArray[m].y + 540, sightArray[m - 1].x + 540, sightArray[m - 1].y + 540);
                        }
                    }*/
